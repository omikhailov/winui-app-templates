...
{
    public class NavigateToInvokedItemAction : DependencyObject, IAction
    {
        ...
        public object Execute(object sender, object parameter)
        {
            ...
            var eventArgs = (Microsoft.UI.Xaml.Controls.NavigationViewItemInvokedEventArgs)parameter;

            ContentFrame.Navigate(pageType, model.Parameter, eventArgs.RecommendedNavigationTransitionInfo);
